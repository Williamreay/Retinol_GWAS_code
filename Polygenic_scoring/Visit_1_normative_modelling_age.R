...
mydata_tmp <- df %>% select(Age_visit1, Batch_visit1, BMI_visit1, Retinol_visit1, Last_digit, PublicID)
...
## Without BMI fits marginally better delta AIC = 1.152595
...
write.table(Dev_1, file="Visit_1_deviations_SHASH.txt",
            sep = "\t", row.names = F)
