...
## Remove any missing values - retinol visit 3
...
mydata_tmp <- df %>% select(Age_visit3, Batch_visit3, BMI_visit3, Retinol_visit3, Last_digit, PublicID)
...
## With BMI fits marginally better delta AIC = -2.376157
...
write.table(Dev_1, file="Visit_3_deviations_BCT.txt",
            sep = "\t", row.names = F)
